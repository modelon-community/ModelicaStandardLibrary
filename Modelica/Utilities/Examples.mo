...
using function <a href=\"modelica://Modelica.Utilities.Streams.writeRealMatrix\">writeRealMatrix</a>.
  ...
  model ReadRealMatrixFromFile
    ...
    final parameter Integer dim[2] = pure(Modelica.Utilities.Streams.readMatrixSize(file,matrixName)) "Dimension of matrix";
    ...
    final parameter Integer dim1[2] = pure(Modelica.Utilities.Streams.readMatrixSize(file1,matrixName1)) "Dimension of check matrix 1";
    final parameter Integer dim2[2] = pure(Modelica.Utilities.Streams.readMatrixSize(file2,matrixName1)) "Dimension of check matrix 2";
    final parameter Integer dim3[2] = pure(Modelica.Utilities.Streams.readMatrixSize(file3,matrixName1)) "Dimension of check matrix 3";
